...
| `map_conflict_rules` | CON-Regeln (6 Zeilen Stand 2026-07-02: CON-02/07/09/11/12/13; CON-02/09/12 seit Migration #12 `aktiv=FALSE` behalten; CON-01/03/04/05/06/08/10 zwischenzeitlich gelöscht, Historie nicht mehr rekonstruierbar), match_typ + action | Node 13 |
